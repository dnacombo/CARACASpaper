...
#SBATCH --output=/network/iss/cenir/analyse/meeg/CARACAS/Test_Max/ds003690/derivatives/CardiClassif_HPF1Hz_SASICA_final/logs/log-%a
#SBATCH --error=/network/iss/cenir/analyse/meeg/CARACAS/Test_Max/ds003690/derivatives/CardiClassif_HPF1Hz_SASICA_final/logs/err/err-%a
#SBATCH --array=1-375
