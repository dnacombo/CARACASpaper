...
toplot(CORRrej & CARArej) = 1;
toplot(CORRrej & ~ CARArej) = 2;
toplot(~CORRrej & ~CARArej) = 3;
toplot(~CORRrej & CARArej) = 4;
...
comp.trial = cellfun(@(x) x(icmp,:),comp.trial, 'UniformOutput',false);
